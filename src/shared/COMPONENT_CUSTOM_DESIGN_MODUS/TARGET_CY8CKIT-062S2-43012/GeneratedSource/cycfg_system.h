 ...
 *
 * @file cycfg_system.h    @brief Infinera Configurations to be used by
 *                                FreeRTOSConfig.h
 *
 * @author Yakubu Miles
 *
 ...
 *
 * @details
 * This file contains configurations used by FreeRTOS. The edits here should not
 * be lost because the ModusToolbox will not be run again.
 *
 ***************************************************************************/
