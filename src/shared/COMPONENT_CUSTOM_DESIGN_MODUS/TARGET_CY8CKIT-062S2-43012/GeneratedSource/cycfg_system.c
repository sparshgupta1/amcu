...
{
    Cy_SysTick_Init(CY_CFG_SYSCLK_CLKALTSYSTICK_SOURCE,
...
__STATIC_INLINE void Cy_SysClk_FllInit()
{
    if (CY_SYSCLK_SUCCESS !=
        Cy_SysClk_FllManualConfigure(&srss_0_clock_0_fll_0_fllConfig))
    {
...
{
    /* Reset the Backup domain on POR, XRES, BOD only if Backup domain is
     * supplied by VDDD */
...
#if (((CY_CFG_SYSCLK_CLKPATH0_SOURCE_NUM >= 3UL) &&                            \
      (CY_CFG_SYSCLK_CLKPATH0_SOURCE_NUM <= 5UL)) &&                           \
     (CY_CFG_SYSCLK_CLKHF0_CLKPATH_NUM == 0UL))
#error Configuration Error : ALTHF, ILO, PILO cannot drive HF0.
#endif
#if (((CY_CFG_SYSCLK_CLKPATH1_SOURCE_NUM >= 3UL) &&                            \
      (CY_CFG_SYSCLK_CLKPATH1_SOURCE_NUM <= 5UL)) &&                           \
     (CY_CFG_SYSCLK_CLKHF0_CLKPATH_NUM == 1UL))
#error Configuration Error : ALTHF, ILO, PILO cannot drive HF0.
#endif
#if (((CY_CFG_SYSCLK_CLKPATH2_SOURCE_NUM >= 3UL) &&                            \
      (CY_CFG_SYSCLK_CLKPATH2_SOURCE_NUM <= 5UL)) &&                           \
     (CY_CFG_SYSCLK_CLKHF0_CLKPATH_NUM == 2UL))
#error Configuration Error : ALTHF, ILO, PILO cannot drive HF0.
#endif
#if (((CY_CFG_SYSCLK_CLKPATH3_SOURCE_NUM >= 3UL) &&                            \
      (CY_CFG_SYSCLK_CLKPATH3_SOURCE_NUM <= 5UL)) &&                           \
     (CY_CFG_SYSCLK_CLKHF0_CLKPATH_NUM == 3UL))
#error Configuration Error : ALTHF, ILO, PILO cannot drive HF0.
#endif
#if (((CY_CFG_SYSCLK_CLKPATH4_SOURCE_NUM >= 3UL) &&                            \
      (CY_CFG_SYSCLK_CLKPATH4_SOURCE_NUM <= 5UL)) &&                           \
     (CY_CFG_SYSCLK_CLKHF0_CLKPATH_NUM == 4UL))
#error Configuration Error : ALTHF, ILO, PILO cannot drive HF0.
#endif
#if (((CY_CFG_SYSCLK_CLKPATH5_SOURCE_NUM >= 3UL) &&                            \
      (CY_CFG_SYSCLK_CLKPATH5_SOURCE_NUM <= 5UL)) &&                           \
     (CY_CFG_SYSCLK_CLKHF0_CLKPATH_NUM == 5UL))
#error Configuration Error : ALTHF, ILO, PILO cannot drive HF0.
#endif

    configStatus = CY_PRA_FUNCTION_CALL_RETURN_PARAM(
        CY_PRA_MSG_TYPE_SYS_CFG_FUNC, CY_PRA_FUNC_INIT_CYCFG_DEVICE,
...
#warning Power system will not be configured. Update power personality to v1.20 or later.
    ...
    Cy_SysClk_ClkSlowSetDivider(0U);
    for (uint32_t pll = CY_SRSS_NUM_PLL; pll > 0UL;
         --pll) /* PLL 1 is the first PLL. 0 is invalid. */
    {
        (void)Cy_SysClk_PllDisable(pll);
    }
    Cy_SysClk_ClkPathSetSource(CY_SYSCLK_CLKHF_IN_CLKPATH1,
                               CY_SYSCLK_CLKPATH_IN_IMO);

    if ((CY_SYSCLK_CLKHF_IN_CLKPATH0 == Cy_SysClk_ClkHfGetSource(0UL)) &&
        (CY_SYSCLK_CLKPATH_IN_WCO ==
         Cy_SysClk_ClkPathGetSource(CY_SYSCLK_CLKHF_IN_CLKPATH0)))
    {
        Cy_SysClk_ClkHfSetSource(0U, CY_SYSCLK_CLKHF_IN_CLKPATH1);
    }

    Cy_SysClk_FllDisable();
    Cy_SysClk_ClkPathSetSource(CY_SYSCLK_CLKHF_IN_CLKPATH0,
                               CY_SYSCLK_CLKPATH_IN_IMO);
...
#if ((CY_CFG_SYSCLK_CLKPATH0_SOURCE_NUM == 0x6UL) &&                           \
     (CY_CFG_SYSCLK_CLKHF0_CLKPATH_NUM == 0U))
