...
#define CY_CAPSENSE_CSD_AUTOTUNE_EN                                            \
    (CY_CAPSENSE_SMARTSENSE_FULL_EN || CY_CAPSENSE_SMARTSENSE_HW_EN)
...
#define CY_CAPSENSE_REGULAR_RC_FILTER_EN                                       \
    (CY_CAPSENSE_REGULAR_RC_IIR_FILTER_EN ||                                   \
     CY_CAPSENSE_REGULAR_RC_MEDIAN_FILTER_EN ||                                \
     CY_CAPSENSE_REGULAR_RC_AVERAGE_FILTER_EN)
...
#define CY_CAPSENSE_PROX_RC_FILTER_EN                                          \
    (CY_CAPSENSE_PROX_RC_IIR_FILTER_EN ||                                      \
     CY_CAPSENSE_PROX_RC_MEDIAN_FILTER_EN ||                                   \
